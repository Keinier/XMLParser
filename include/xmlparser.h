...
#else
	#include "xmlparser.h"
	#define STRING		XMLString
#endif

// Deprecated library function hell. Compilers want to use the
// new safe versions. This probably doesn't fully address the problem,
// but it gets closer. There are too many compilers for me to fully
// test. If you get compilation troubles, undefine SAFE
#define SAFE
...
const XMLEncoding DEFAULT_ENCODING = ENCODING_UNKNOWN;
...
public:
	...
	*/
	...
	virtual const char* Parse(	const char* p, 
								XMLParsingData* data, 
								XMLEncoding encoding /*= ENCODING_UNKNOWN */ ) = 0;
...
public:
	...
	/** QueryIntValue examines the value string. It is an alternative to the
		...
		the call returns SUCCESS. If it is not
		an integer, it returns WRONG_TYPE.
...
public:
	...
	*/
	...
	/** QueryIntAttribute examines the attribute - it is an alternative to the
		...
		the call returns SUCCESS. If it is not
		an integer, it returns WRONG_TYPE. If the attribute
		does not exist, then NO_ATTRIBUTE is returned.
	*/	
	...
	*/
	...
	/** Template form of the attribute query which will try to read the
		...
		@return SUCCESS, WRONG_TYPE, or NO_ATTRIBUTE
	*/
...
protected:
	...
	virtual void StreamIn( std::istream * in, STRING * tag );
	#endif
//	virtual void StreamOut( OSTREAM * out ) const;
...
public:
	...
	*/
	bool LoadFile( XMLEncoding encoding = DEFAULT_ENCODING );
	/// Save a file using the current document value. Returns true if successful.
	bool SaveFile() const;
	/// Load a file using the given filename. Returns true if successful.
	bool LoadFile( const char * filename, XMLEncoding encoding = DEFAULT_ENCODING );
	...
	*/
	bool LoadFile( FILE*, XMLEncoding encoding = DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
	bool SaveFile( FILE* ) const;

	#ifdef USE_STL
	bool LoadFile( const std::string& filename, XMLEncoding encoding = DEFAULT_ENCODING )			///< STL std::string version.
	{
	...
	*/
	virtual const char* Parse( const char* p, XMLParsingData* data = 0, XMLEncoding encoding = DEFAULT_ENCODING );
